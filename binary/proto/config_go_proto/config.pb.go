...
type PluginSpecificConfig struct {
	...
	//	*PluginSpecificConfig_DependencyConfusion
...
func (x *PluginSpecificConfig) GetDependencyConfusion() *DependencyConfusionConfig {
	if x != nil {
		if x, ok := x.Config.(*PluginSpecificConfig_DependencyConfusion); ok {
			return x.DependencyConfusion
		}
	}
	return nil
}
...
type PluginSpecificConfig_DependencyConfusion struct {
	DependencyConfusion *DependencyConfusionConfig `protobuf:"bytes,72,opt,name=dependency_confusion,json=dependencyConfusion,proto3,oneof"`
}
...
func (*PluginSpecificConfig_DependencyConfusion) isPluginSpecificConfig_Config() {}
...
type DependencyConfusionConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A list of internal NPM namespaces (e.g. "@mycompany/").
	InternalNamespaces []string `protobuf:"bytes,1,rep,name=internal_namespaces,json=internalNamespaces,proto3" json:"internal_namespaces,omitempty"`
	// A list of internal NPM packages (e.g. "my-secret-lib").
	InternalPackages []string `protobuf:"bytes,2,rep,name=internal_packages,json=internalPackages,proto3" json:"internal_packages,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *DependencyConfusionConfig) Reset() {
	*x = DependencyConfusionConfig{}
	mi := &file_proto_config_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DependencyConfusionConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DependencyConfusionConfig) ProtoMessage() {}

func (x *DependencyConfusionConfig) ProtoReflect() protoreflect.Message {
	mi := &file_proto_config_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DependencyConfusionConfig.ProtoReflect.Descriptor instead.
func (*DependencyConfusionConfig) Descriptor() ([]byte, []int) {
	return file_proto_config_proto_rawDescGZIP(), []int{3}
}

func (x *DependencyConfusionConfig) GetInternalNamespaces() []string {
	if x != nil {
		return x.InternalNamespaces
	}
	return nil
}

func (x *DependencyConfusionConfig) GetInternalPackages() []string {
	if x != nil {
		return x.InternalPackages
	}
	return nil
}
...
const file_proto_config_proto_rawDesc = "" +
	...
	"\x0fplugin_specific\x18\x02 \x03(\v2\x1d.scalibr.PluginSpecificConfigR\x0epluginSpecific\"\xc1\x1d\n" +
	...
	"\tnuget_cpm\x18G \x01(\v2\x17.scalibr.NugetCPMConfigH\x00R\bnugetCpm\x12W\n" +
	"\x14dependency_confusion\x18H \x01(\v2\".scalibr.DependencyConfusionConfigH\x00R\x13dependencyConfusionB\b\n" +
	"\x06configJ\x04\b0\x109J\x04\b;\x10>J\x04\bB\x10D\"B\n" +
	"\x0eGoBinaryConfig\x120\n" +
	"\x14version_from_content\x18\x01 \x01(\bR\x12versionFromContent\"y\n" +
	"\x19DependencyConfusionConfig\x12/\n" +
	"\x13internal_namespaces\x18\x01 \x03(\tR\x12internalNamespaces\x12+\n" +
	"\x11internal_packages\x18\x02 \x03(\tR\x10internalPackages\"D\n" +
...
var file_proto_config_proto_goTypes = []any{
	...
	(*DependencyConfusionConfig)(nil),          // 3: scalibr.DependencyConfusionConfig
	...
	(*DotnetPackagesConfigConfig)(nil),         // 37: scalibr.DotnetPackagesConfigConfig
	(*DotnetPackagesLockJsonConfig)(nil),       // 38: scalibr.DotnetPackagesLockJsonConfig
	(*DotnetPeConfig)(nil),                     // 39: scalibr.DotnetPeConfig
	(*GemspecConfig)(nil),                      // 40: scalibr.GemspecConfig
	(*CargoAuditableConfig)(nil),               // 41: scalibr.CargoAuditableConfig
	(*SwiftPackageResolvedConfig)(nil),         // 42: scalibr.SwiftPackageResolvedConfig
	(*SwiftPodfileLockConfig)(nil),             // 43: scalibr.SwiftPodfileLockConfig
	(*ElixirMixLockConfig)(nil),                // 44: scalibr.ElixirMixLockConfig
	(*HaskellStacklockConfig)(nil),             // 45: scalibr.HaskellStacklockConfig
	(*HaskellCabalConfig)(nil),                 // 46: scalibr.HaskellCabalConfig
	(*JavaArchiveConfig)(nil),                  // 47: scalibr.JavaArchiveConfig
	(*JavascriptPackageJsonConfig)(nil),        // 48: scalibr.JavascriptPackageJsonConfig
	(*JavascriptPackageLockJsonConfig)(nil),    // 49: scalibr.JavascriptPackageLockJsonConfig
	(*PythonRequirementsConfig)(nil),           // 50: scalibr.PythonRequirementsConfig
	(*PythonSetupConfig)(nil),                  // 51: scalibr.PythonSetupConfig
	(*PythonCondametaConfig)(nil),              // 52: scalibr.PythonCondametaConfig
	(*PythonWheelEggConfig)(nil),               // 53: scalibr.PythonWheelEggConfig
	(*GoModConfig)(nil),                        // 54: scalibr.GoModConfig
	(*WordpressPluginsConfig)(nil),             // 55: scalibr.WordpressPluginsConfig
	(*MariadbConfig)(nil),                      // 56: scalibr.MariadbConfig
	(*OSVLocalConfig)(nil),                     // 57: scalibr.OSVLocalConfig
...
var file_proto_config_proto_depIdxs = []int32{
	...
	37, // 28: scalibr.PluginSpecificConfig.dotnet_packages_config:type_name -> scalibr.DotnetPackagesConfigConfig
	38, // 29: scalibr.PluginSpecificConfig.dotnet_packages_lock_json:type_name -> scalibr.DotnetPackagesLockJsonConfig
	39, // 30: scalibr.PluginSpecificConfig.dotnet_pe:type_name -> scalibr.DotnetPeConfig
	40, // 31: scalibr.PluginSpecificConfig.gemspec:type_name -> scalibr.GemspecConfig
	41, // 32: scalibr.PluginSpecificConfig.cargo_auditable:type_name -> scalibr.CargoAuditableConfig
	42, // 33: scalibr.PluginSpecificConfig.swift_package_resolved:type_name -> scalibr.SwiftPackageResolvedConfig
	43, // 34: scalibr.PluginSpecificConfig.swift_podfile_lock:type_name -> scalibr.SwiftPodfileLockConfig
	44, // 35: scalibr.PluginSpecificConfig.elixir_mix_lock:type_name -> scalibr.ElixirMixLockConfig
	45, // 36: scalibr.PluginSpecificConfig.haskell_stacklock:type_name -> scalibr.HaskellStacklockConfig
	46, // 37: scalibr.PluginSpecificConfig.haskell_cabal:type_name -> scalibr.HaskellCabalConfig
	47, // 38: scalibr.PluginSpecificConfig.java_archive:type_name -> scalibr.JavaArchiveConfig
	48, // 39: scalibr.PluginSpecificConfig.javascript_package_json:type_name -> scalibr.JavascriptPackageJsonConfig
	49, // 40: scalibr.PluginSpecificConfig.javascript_package_lock_json:type_name -> scalibr.JavascriptPackageLockJsonConfig
	50, // 41: scalibr.PluginSpecificConfig.python_requirements:type_name -> scalibr.PythonRequirementsConfig
	51, // 42: scalibr.PluginSpecificConfig.python_setup:type_name -> scalibr.PythonSetupConfig
	52, // 43: scalibr.PluginSpecificConfig.python_condameta:type_name -> scalibr.PythonCondametaConfig
	53, // 44: scalibr.PluginSpecificConfig.python_wheel_egg:type_name -> scalibr.PythonWheelEggConfig
	54, // 45: scalibr.PluginSpecificConfig.go_mod:type_name -> scalibr.GoModConfig
	55, // 46: scalibr.PluginSpecificConfig.wordpress_plugins:type_name -> scalibr.WordpressPluginsConfig
	56, // 47: scalibr.PluginSpecificConfig.mariadb:type_name -> scalibr.MariadbConfig
	57, // 48: scalibr.PluginSpecificConfig.osvlocal:type_name -> scalibr.OSVLocalConfig
	58, // 49: scalibr.PluginSpecificConfig.code_server:type_name -> scalibr.CodeServerConfig
	6,  // 50: scalibr.PluginSpecificConfig.denojson:type_name -> scalibr.DenoJsonConfig
	7,  // 51: scalibr.PluginSpecificConfig.denotssource:type_name -> scalibr.DenoTSSourceConfig
	59, // 52: scalibr.PluginSpecificConfig.qcow2:type_name -> scalibr.QCOW2Config
	12, // 53: scalibr.PluginSpecificConfig.cpan:type_name -> scalibr.PerlCPANConfig
	16, // 54: scalibr.PluginSpecificConfig.python_requirements_transitive:type_name -> scalibr.PythonRequirementsTransitiveConfig
	27, // 55: scalibr.PluginSpecificConfig.spack:type_name -> scalibr.SpackConfig
	35, // 56: scalibr.PluginSpecificConfig.csproj:type_name -> scalibr.CsProjConfig
	36, // 57: scalibr.PluginSpecificConfig.nuget_cpm:type_name -> scalibr.NugetCPMConfig
	3,  // 58: scalibr.PluginSpecificConfig.dependency_confusion:type_name -> scalibr.DependencyConfusionConfig
...
func file_proto_config_proto_init() {
	...
	file_proto_config_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*PluginSpecificConfig_DependencyConfusion)(nil),
	}
	file_proto_config_proto_msgTypes[47].OneofWrappers = []any{}
	file_proto_config_proto_msgTypes[56].OneofWrappers = []any{}
	type x struct{}
